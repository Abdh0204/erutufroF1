...
Top-level entry point:
    ``compute_news_sentiment(cache, fmp_client, symbol, gemini_client=None)``
"""
...
def compute_news_sentiment(
    ...
    *,
    ...
    fmp_client:
        FMPClient instance for fetching news.
    gemini_client:
    ...
    elif fmp_client is not None and symbol:
        try:
            articles = fmp_client.get_stock_news(symbol, limit=1000)
